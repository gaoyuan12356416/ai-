...
The service reads Meta Campaign, Ad Set, and Ad copy logs plus matched insight rows from the existing read-only MySQL endpoint. It refuses any configured port other than `63350` and verifies `@@read_only=1`.
