#!/usr/bin/env python3
"""Require a verified YouTube Player Card before sharing; main API only."""
import argparse
import fcntl
import json
import os
...
FILES = {
    'features/youtube_auto_publish/x_card.py': None,
    'features/youtube_auto_publish/x_share.py': '028973e22c775eeabab4eadb4460948d1038e9925855259a2ac1f53544213bdf',
    'features/x_accounts/youtube_share_text.py': '423b15e9960c95804dcfa9fba7a057ce228a46062e5bd7f0db2002057b44a460',
    'static/youtube-publish.js': '2487548f3659aa167c4704abbd0807189c2980f4b68b85b7099ab9b5639e6671',
    'static/youtube-publish.html': '6459cdda30e750f83e49037ec93e73d204ff2cd543853d4a501f24f439fc4eee',
}
KIND = 'youtube-share-player'
