...
每天北京时间 11:00 向群 `oc_7c683c5770aef2e6c84a456e52cad389` 发送独立飞书卡片。用户确认口径为“全部内容的昨日效果 + 昨日发布量”。
...
- 发布量默认按北京时间昨天 00:00–24:00；`--publication-timezone UTC` 可统一为 UTC。
- 效果按源表昨日 UTC 日期，等于北京时间当日 08:00–次日 08:00。源表只有天粒度，不能假称精确的北京时间自然日。
