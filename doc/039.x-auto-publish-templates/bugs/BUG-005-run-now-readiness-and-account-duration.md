...
状态：已于 2026-08-12 修复并完成无额外 Post 的生产验收。
...
- exact release：`0a27b66ff9651d665a19675ac01c8e6c44713283`；服务器回归 159/159。
- 三门禁全开，模板 `1` 仍停用；只读 preview 从 270 秒候选收紧为素材 `6120551`
  的 92 秒，`reserved=false`。
- 自然 scheduler/runner 成功，X Auto run/task/ledger 均为 0；既有 X 账本保持
  `187/187/186`，unknown 为 0，Token 哈希不变，未新增真实 Post。
