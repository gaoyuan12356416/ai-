...
BACKUP=Path('/data/random-overlay-gpu/backups/20260920-stalled-prepare')
...
before=snapshot()
assert before['age_seconds']>3600 and before['bytes']==9175088
time.sleep(10)
after=snapshot()
...
files=[]
for name in ['source.mp4','output.tmp.mp4','compositor-7942fa310135967662b4.cl']:
    source=JOB/name
    target=BACKUP/name
