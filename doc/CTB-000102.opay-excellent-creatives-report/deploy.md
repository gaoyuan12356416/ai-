...
## 2026-09-15 月度更新时间调整（当前调度）

当前仅启用 `opay-excellent-creatives-final.timer`，北京时间每月 2 日 08:00 刷新上一完整月份；原初版定时器停用。迁移、验证和精确回滚步骤见 [release-monthly-schedule-20260915.md](release-monthly-schedule-20260915.md)。以下历史发布段落中的 3 日/5 日计划和双定时器启用步骤已被本节替代。

## 2026-08-27 图片/视频全基准与1000美元门槛（数据规则，调度已由上节替代）
...
## 历史发布（15:22，已由上方新口径替代）

Google CPC / 图片视频CTR旧规则于2026-08-27北京时间15:22上线，精确提交`72f2e7440e16d8d3ea782ce9eea31176d21c0797`。该历史版本、七个月结果、备份及回滚程序见[Google CPC实际发布记录](release-google-cpc-20260827.md)。本轮最终运行提交为295b14d，数据版本20260827T173321821817+0800；以本文顶部链接的新口径发布记录为准。下文V1/V2部署与PENDING交接均为历史。
