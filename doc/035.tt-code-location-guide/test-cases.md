...
| TC-005 | 搜索失败 | 初始页面 | 搜索无效/不存在 code | guide 保留，不阻断错误提示 | P0 | 待生产复验 |
...
| TC-012 | immutable资源 | 部署后 | GET hashed WebP | 200、image/webp、一年immutable | P0 | 待生产复验 |
...
| TC-015 | 双入口/路径合同 | 请求三个路径 | GET `/tt`、`/tt-code`、`/tt/` | 前两者200，尾斜杠仍404 | P0 | 待生产复验 |
