...
| 评论/同步 | published 后评论；force-ssl；comment-only retry/unknown；outbox；受控 RPC configured success/missing/auth/redirect/unknown；三实体 exact keys/types/required；extra/missing/type 与三 identity mismatch 拒绝；坏 JSON/非 object/contract error fenced finish failed；无 DDL DELETE secrets |
