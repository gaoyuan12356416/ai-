...
当前实际部署/真实canary/备份/停止边界统一见[上线验收记录](release-acceptance-20260827.md)。指定一次非公开视频及一条评论、新三表同步与同任务幂等均通过；17:45正式live/sync已开启，最终静态978746f与线上表单完成验证。不要重跑下方历史建账号/旧库迁移步骤，也不要把文档提交号替代已测组件版本。
