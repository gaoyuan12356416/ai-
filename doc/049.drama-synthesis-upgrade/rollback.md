...
本次已发生真实外部事实：视频HGgjhhRXS-I、评论Ugwktiv9_nnXb1TN_c54AaABAg及发布任务1。最新备份与版本见[上线验收](release-acceptance-20260827.md)。必须保留新三表、SQLite/outbox、短链/COS和这些外部ID，禁止用发布前SQLite覆盖它们；默认只回滚本次源码/配置并关live/sync，不DROP、不删除视频或评论。
